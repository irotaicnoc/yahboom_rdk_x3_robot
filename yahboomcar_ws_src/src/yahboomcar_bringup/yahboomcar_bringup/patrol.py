...
class YahboomCarPatrol(Node):
    ...
    def Spin(self, angle):
        ...
        self.delta_angle = self.RotationScaling * self.normalize_angle(odom_angle - self.last_angle)
        self.turn_angle += self.delta_angle
        print("turn_angle: ", self.turn_angle)
        self.error = target_angle - self.turn_angle
    ...
    def get_odom_angle(self):
        try:
            ...
            cacl_rot = PyKDL.Rotation.Quaternion(rot.transform.rotation.x, rot.transform.rotation.y,
