...
class RobotBody(object):
    ...
    #   4: gradient light, 5: starlight, 6: power display
    # Speed =[1, 10], the smaller the value, the faster the speed changes
    # Parm, left blank, as an additional argument.  Usage 1: The color of breathing lamp can be modified
    ...
    # If enable=0: turn off the torque force of the steering gear, the steering gear can be turned by hand, but
    # the command cannot control the rotation.
